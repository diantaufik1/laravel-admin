            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{route('coba.create') }}" class="btn btn-primary pull-right">Tambah</a>
                    </div>
                    <div class="card-body">
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->nama }}</td>
                                    <td>{{ $row->nomer }}</td>
                                    <td class="text-center"><a href="{{ route('coba.edit', $row->id) }}" class="btn btn-primary">Edit</a></td>
                                    <td class="text-center">
                                        <form action="{{ route('coba.destroy', $row->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
