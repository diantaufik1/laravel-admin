                        ...
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Keterangan</th>
                                    <th>Status</th>
                                    @can('tugas-edit')<th>Edit</th>@endcan
                                    @can('tugas-delete')<th>Hapus</th>@endcan
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @can('tugas-edit')
                                    <td class="text-center"><a href="{{ route('tugas.edit', $row->id) }}" class="btn btn-primary">Edit</a></td>
                                    @endcan
                                    @can('tugas-delete')
