<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./"><img src="{{asset('public/images/logo3.jpeg')}}" width="50" alt="Logo"></a>
            <a class="navbar-brand hidden" href="./"><img src="{{asset('public/images/logo3.jpeg')}}" alt="Logo"></a>
        </div>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active">
                    ...
                    <a href="{{url('/admin/coba')}}"> <i class="menu-icon fa fa-dashboard"></i>Coba </a>
                    <a href="{{url('/admin/cobaa')}}"> <i class="menu-icon fa fa-dashboard"></i>COBAa </a>
                    <a href="{{url('/admin/pegawai')}}"> <i class="menu-icon fa fa-dashboard"></i>Pegawai </a>
                    <a href="{{url('/admin/menu')}}"> <i class="menu-icon fa fa-dashboard"></i>Menu030 </a>
                    @role('admin')
